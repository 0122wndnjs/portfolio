  ...
  { icon: <FaEnvelope />, label: "이메일", value: "0122wndnjs@gmail.com" },
  {
    ...
    value: (
      <div>
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">Major: Computer Science</div>
        <div className="text-sm text-gray-500 dark:text-gray-400">Minor: Mathematics</div>
      </div>
    ),
  },
];
        ...
        {profileData.map(({ icon, label, value }, idx) => (
          ...
          >
            ...
            <div>
              ...
              <div className="text-gray-700 dark:text-gray-300 text-sm sm:text-base">{value}</div>
            </div>
          </div>
        ))}
      </div>
